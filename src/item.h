...
class Item : virtual public Thing, public ItemAttributes
{
	public:
        ...
        const bool* v = getBooleanAttribute("isMovable");
			if(v) 
				return v;
		...
		bool isWaterTile() const {
            ...
            bool ret = false;
    		const int waters[22] = {4608, 4609, 4610, 4611, 4612, 4613, 4614, 4615, 4616, 4617, 4618, 4619, 4820, 4821, 4822, 4823, 4824, 4825, 4828, 4829, 4830, 4831};
          //Configurações do andar na água                  
    		for(int i = 0; i < 22; i++){
    		   bool isWater = id == waters[i];
    		   if(isWater){
                 ret = true; 
                 break;  
               }
