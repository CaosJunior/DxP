...
bool ConfigManager::load()
{
	...
	m_confNumber[hungryDropTime] = getGlobalNumber("hungryDropTime");  
	m_confNumber[decreaseHungry] = getGlobalNumber("decreaseHungry");  
	m_confNumber[decreaseHappy] = getGlobalNumber("decreaseHappy"); 
    m_confNumber[valorParaPedirComida] = getGlobalNumber("valorParaPedirComida");  
	m_confNumber[minHappinessEffectDelay] = getGlobalNumber("minHappinessEffectDelay");  
	m_confNumber[maxHappinessEffectDelay] = getGlobalNumber("maxHappinessEffectDelay");  
	m_confString[GHOSTS_POKE_NAMES] = getGlobalString("ghostPokemonNames");
     
	//g_config.getNumber(ConfigManager::happyDropTime)
